...
%SF full_filename = String;
%SF load(full_filename);
...
%SF     figure(1)
%SF     scatter3(X1(IND),X2(IND),X3(IND),10,(X4(IND)),'filled')
%SF     axis equal
%SF     drawnow
%SF     colormap jet
%SF     pause(.5)
...
Final_Loc_Blinking_Corrected=LocalizationsFinal;
Final_Frame_Blinking_Corrected=Frame_Information;
%SF save(['Combined_Final_',Condition],'Final_Loc_Blinking_Corrected','Final_Frame_Blinking_Corrected')


%%
%SF scatter(Final_Loc_Blinking_Corrected{1}(:,1),Final_Loc_Blinking_Corrected{1}(:,2),20, Frame_Information{1},'filled')
%SF axis equal
%SF     drawnow
%SF     colormap jet