...
%SF     if length(DistanceControl2)<2000
%SF         disp('WARNING: You do not have enough data to define a true distribution, if you have split an image consider combining multiple images!!')
%SF     end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    while steps<step_total
        ...
        if toc>timer
%SF             disp('Stopping to save some of the data')
            break
        end
...
%SF                 scatter(loc(:,1),loc(:,2),10,(fram),'filled')
%SF                 colormap jet
%SF                 axis equal
%SF                 drawnow
...
%SF         disp(['Fraction Complete', ' = ', num2str(steps/step_total),' Score (If know truth)= ', num2str(scorey),' Image= ', num2str(ksu)])
    end
